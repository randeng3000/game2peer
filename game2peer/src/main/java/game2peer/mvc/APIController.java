...
public class APIController extends ApplicationObjectSupport {
	...
	public Object requestAPI(HttpServletRequest request, HttpServletResponse response, @PathVariable String id,
